...
public class ExtentReports1 {
    //utilities ==> new java class ==>> TestBaseFinal

//    ExtentReports ===>      Raporlamaya baslamak icin buna ihtiyacimiz var.
//                            Raporu kapatmak icin "flush()" kullaniyoruz
//    ExtentHtmlReporter ===> Raporlari yapilandirmaya (configuration) yardimci olur.
//                            Html raporlarini create eder
//    ExtentTest  ===>        Aciklama(logs) eklemek icin, test adimlarini belirlemek icin kullanilir

//    instance variable: extentReports, extentHtmlReporter, extentTest
    ...
    @BeforeTest
    public void setup(){
        //reporter'i baslatalim ve konumunu ayarlayalim.    ===> *** "./reports/extentreport.html"); bunu kodla biz
//                                                                          create ettik ve projenin altina ekledik
        //                                             klasor: reports, dosya adi: extentreport.html
        extentHtmlReporter = new ExtentHtmlReporter("./reports/extentreport.html");//==> Bir dosya create etmis
//                                                                                                             olduk
        ...
        extentReports.setSystemInfo("Automation engineer", "Resit");
